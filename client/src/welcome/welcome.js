...
export default function Welcome(){
    return(
        ...
        <div className="aboutSect">
            ...
            <p className="instructions">You'll be prompted with a question. Respond by searching for a song.</p>
            <p className="instructions">Add friends. See their responses.</p>
            <p className="instructions">Browse playlists of responses, organized by prompt.</p>
        </div>
